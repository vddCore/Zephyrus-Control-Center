...
namespace Slate.Infrastructure.Native
{
    ...
    internal delegate int ADL_Display_DisplayInfo_Get(int adapterIndex, ref int numDisplays,
    ...
    internal static class ADL
    {
        ...
        private static class ADLImport
        {
            ...
            internal static extern int ADL_Main_Control_Create(ADL_Main_Memory_Alloc callback,
            ...
            [DllImport(Atiadlxx_FileName)]
            internal static extern int ADL_Display_DisplayInfo_Get(int adapterIndex, ref int numDisplays,
                out IntPtr displayInfoArray, int forceDetect);
        ...
        private class ADLCheckLibrary
        {
            ...
            private ADLCheckLibrary()
            {
                try
                {
                    ...
                    {
                        ADLLibrary = Kernel32.GetModuleHandle(ADLImport.Atiadlxx_FileName);
                    }
                }
